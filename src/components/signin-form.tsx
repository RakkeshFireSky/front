...
export function SigninForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setLoading(true)
            const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/api/sign-in`, form)
                    ...
                    <form className="p-6 md:p-8" style={{ padding: '20px' }}>
                        <FieldGroup>
                            ...
                            <Field> 
                                ...
                                <Input style={{ padding: '12px' }} onChange={handleOnChange} name="password" value={form.password} id="password" type="password" required />
                            </Field>
                            <Field>
                                <Button type="submit" onClick={handleSubmit}>{loading ? "Loading...." : "Login Account"}</Button>
                            </Field>
